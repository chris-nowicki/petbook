    ...
    return(
        ...
        <div className='App'>
            ...
            <div className='flex flex-col rounded border border-black p-4 shadow-md shadow-black/25 items-center mt-6'>
                ...
                <button  className="w-full bg-stone-300 px-4 py-2 my-3 rounded hover:bg-orange-100" onClick={getDog}>Get A Dog!</button>
                <div className='getForm items-center justify-center'>
                    <form c onSubmit={onSubmitHandler}>
                        ...
                        <textarea rows="3" className=" p-2 w-full rounded-lg border border-gray-300" type = 'text' onChange={(e)=>setCaption(e.target.value)} placeholder="add a caption"/>
                        <div>
                            <p className='ml-1 text-sm '>*8 characters required</p>
                        </div>
                        <div className='flex flex-row justify-center'>
                            <button className=' bg-stone-300 px-4 py-2 my-3 rounded hover:bg-orange-100' type ='submit'>Save This Puppers!</button>
                        </div>
                    </form>
                </div>
                </div>
