    ...
    return (
        <div>ViewOne
            ...
            <form onSubmit ={handleComment}>
                ...
                <input type="text-area" className='border border-black' onChange ={(e)=> setNewComment(e.target.value)}/>
                <button className=" w-half border border-black bg-black py-3 text-xl text-white shadow-md shadow-black/25">Submit</button>
            </form>
        </div>
    )
}
